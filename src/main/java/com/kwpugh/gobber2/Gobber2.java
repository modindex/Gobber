	...
	public static class RegistryEvents
	{
		...
		public static void registerItems(final RegistryEvent.Register<Item> event)
		{
			...
			(
				...
				ItemList.gobber2_sword_nether = new ItemCustomSwordNether(ToolMaterialList.gobber2_nether, 4, 4.0f, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_sword_nether")),
				ItemList.gobber2_sword_sniper = new ItemCustomSwordSniper(ToolMaterialList.gobber2_nether, 6, 4.0f, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_sword_sniper")),
				ItemList.gobber2_sword_traveler = new ItemCustomSwordTraveler(ToolMaterialList.gobber2_nether, 6, 4.0f, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_sword_traveler")),
				ItemList.gobber2_pickaxe_nether = new ItemCustomPickaxeNether(ToolMaterialList.gobber2_nether, -14, 4.0f, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_pickaxe_nether")),
				ItemList.gobber2_paxel_nether = new ItemCustomPaxelNether(-14, 4.0f, ToolMaterialList.gobber2_nether, null, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_paxel_nether")),
				ItemList.gobber2_paxel_stars = new ItemCustomPaxelStars(-14, 4.0f, ToolMaterialList.gobber2_nether, null, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_paxel_stars")),
				ItemList.gobber2_shovel_nether = new ItemCustomShovelNether(ToolMaterialList.gobber2_nether, -14.0f, 4.0f, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_shovel_nether")),
				ItemList.gobber2_axe_nether = new ItemCustomAxeNether(ToolMaterialList.gobber2_nether, -14.0f, 4.0f, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_axe_nether")),
				ItemList.gobber2_hoe_nether = new ItemCustomHoeNether(ToolMaterialList.gobber2_nether, 4.0f, 0, new Item.Properties().group(gobber2)).setRegistryName(location("gobber2_hoe_nether")),
