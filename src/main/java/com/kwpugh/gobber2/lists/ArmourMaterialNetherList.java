...
public enum ArmourMaterialNetherList implements IArmorMaterial
{
	...
	private ArmourMaterialNetherList(String name, int durability, int[] damageReductionAmounts, int enchantability, Item repairItem, String equipSound, float toughness) 
	{
		this.name = name;
